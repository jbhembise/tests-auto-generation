...
public class User_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jbhembise.testauto.example6.User"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(User_ESTest_scaffolding.class.getClassLoader() ,
      "jbhembise.testauto.example6.Media",
      "jbhembise.testauto.example6.User"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jbhembise.testauto.example6.Media", false, User_ESTest_scaffolding.class.getClassLoader()));
  }
