...
public class RegressionTest2 {
    ...
    public void test1069() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass22 = user2.getClass();
        org.junit.Assert.assertNotNull(wildcardClass3);
        org.junit.Assert.assertTrue("'" + str4 + "' != '" + "hi!" + "'", str4.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str7 + "' != '" + "" + "'", str7.equals(""));
        org.junit.Assert.assertTrue("'" + str8 + "' != '" + "hi!" + "'", str8.equals("hi!"));
    ...
    public void test1072() throws Throwable {
        ...
        jbhembise.testauto.example5.Media media20 = null;
        user2.borrow(media20);
        java.util.List<jbhembise.testauto.example5.Media> mediaList22 = user2.getBorrowedMedias();
        org.junit.Assert.assertNotNull(wildcardClass3);
        org.junit.Assert.assertTrue("'" + str4 + "' != '" + "hi!" + "'", str4.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str5 + "' != '" + "hi!" + "'", str5.equals("hi!"));
        org.junit.Assert.assertNotNull(mediaList6);
    ...
    public void test1110() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass13 = mediaList11.getClass();
        org.junit.Assert.assertNotNull(wildcardClass3);
        org.junit.Assert.assertTrue("'" + str4 + "' != '" + "hi!" + "'", str4.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str7 + "' != '" + "" + "'", str7.equals(""));
        org.junit.Assert.assertTrue("'" + str8 + "' != '" + "hi!" + "'", str8.equals("hi!"));
    ...
    public void test1309() throws Throwable {
        ...
        user2.borrow(media20);
        java.util.List<jbhembise.testauto.example5.Media> mediaList22 = user2.getBorrowedMedias();
        jbhembise.testauto.example5.Media media23 = null;
        user2.borrow(media23);
        jbhembise.testauto.example5.Media media25 = null;
    ...
    public void test1313() throws Throwable {
        ...
        jbhembise.testauto.example5.Media media25 = null;
        user2.borrow(media25);
        java.util.List<jbhembise.testauto.example5.Media> mediaList27 = user2.getBorrowedMedias();
        org.junit.Assert.assertNotNull(wildcardClass3);
        org.junit.Assert.assertTrue("'" + str4 + "' != '" + "hi!" + "'", str4.equals("hi!"));
        org.junit.Assert.assertTrue("'" + str7 + "' != '" + "" + "'", str7.equals(""));
        org.junit.Assert.assertTrue("'" + str8 + "' != '" + "hi!" + "'", str8.equals("hi!"));
